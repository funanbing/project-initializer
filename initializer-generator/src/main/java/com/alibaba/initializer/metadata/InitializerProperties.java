...
public class InitializerProperties extends InitializrConfiguration {
     ...
     */
    @JsonIgnore
    private final InitializrProperties.SimpleElement groupId = new InitializrProperties.SimpleElement("com.jiuxiniot");
     ...
     */
    @JsonIgnore
    private final InitializrProperties.SimpleElement name = new InitializrProperties.SimpleElement("jx-demo-service");

    /**
     * Description metadata.
     */
    @JsonIgnore
    private final InitializrProperties.SimpleElement description = new InitializrProperties.SimpleElement("玖欣模板项目");

    /**
     * Package name metadata.
     */
    @JsonIgnore
    private final InitializrProperties.SimpleElement packageName = new InitializrProperties.SimpleElement("com.jiuxiniot");
